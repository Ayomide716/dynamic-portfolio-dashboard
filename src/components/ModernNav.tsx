...
import { Github, Linkedin, Mail, Search, Menu, X } from "lucide-react";
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary w-48"
              />
            </div>
